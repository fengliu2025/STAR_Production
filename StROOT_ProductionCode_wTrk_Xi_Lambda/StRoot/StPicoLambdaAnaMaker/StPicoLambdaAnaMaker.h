...
private:
  ...
  Float_t DauLambda_pt[1000];
  Float_t DauLambda_eta[1000];
  Float_t DauLambda_phi[1000];
  Float_t DauLambda_mass[1000]; 
  // Dau proton of Dau Lambda
  Int_t DauLambda_Dau1_InEventID[1000]; 
  Float_t DauLambda_Dau1_pt[1000]; 
  Float_t DauLambda_Dau1_eta[1000];
  Float_t DauLambda_Dau1_phi[1000];
  Int_t   DauLambda_Dau1_ch[1000];
  Float_t DauLambda_Dau1_dca[1000];
  //Dau pion of Dau Lambda
  Int_t DauLambda_Dau2_InEventID[1000];
  Float_t DauLambda_Dau2_pt[1000];
  Float_t DauLambda_Dau2_eta[1000];
  Float_t DauLambda_Dau2_phi[1000];
  Int_t   DauLambda_Dau2_ch[1000]; 
  Float_t DauLambda_Dau2_dca[1000];
  // Dau pion3 
  Int_t   pion3_InEventID[1000];
  Float_t pion3_pt[1000];
  Float_t pion3_eta[1000];
  Float_t pion3_phi[1000];
  Int_t   pion3_ch[1000];
  Float_t pion3_dca[1000];
  //Xi pair 
  Int_t Xi_Charge[1000];
  Float_t Xi_DCAdaughters[1000];
  Float_t Xi_theta[1000]; 
  Float_t Xi_DecayL[1000];
  Float_t Xi_pt[1000];
  Float_t Xi_eta[1000];
  Float_t Xi_phi[1000];
  Float_t Xi_mass[1000];
  Float_t Xi_DCA[1000];
